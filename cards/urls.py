...
urlpatterns = [
    ...
    path('schools/save/<int:pk>/', views.SchoolUpdateView.as_view(), name='school_save'),
    path('students/', views.student_list, name='student_list'),
    path('students/<slug:slug>/', views.student_detail, name='student_detail'),
    ...
    path('students/parents/add/<int:student_id>/', views.parentstudent_add, name='parentstudent_add'),
